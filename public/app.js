...
marker.addTo(myMap).bindPopup('<p1><b>Hello general Kenobi!</b></p1>').openPopup()
...
]).addTo(myMap).bindPopup('2nd arrondissement')
...
const sSD = L.marker([48.869531786321566, 2.3528590208055196], {icon: redIcon}).bindPopup('Strasbourg-Saint-Denis')
const sentier = L.marker([48.8673721067762, 2.347107922912739], {icon: redIcon}).bindPopup('Sentier')
const bourse = L.marker([48.86868503971672, 2.3412285142058167], {icon: redIcon}).bindPopup('Bourse')
const qS = L.marker([48.869560129483226, 2.3358638645569543], {icon: redIcon}).bindPopup('Quatre Septembre')
const gB = L.marker([48.871282159004856, 2.3434818588892714], {icon: redIcon}).bindPopup('Grands Boulevards')
